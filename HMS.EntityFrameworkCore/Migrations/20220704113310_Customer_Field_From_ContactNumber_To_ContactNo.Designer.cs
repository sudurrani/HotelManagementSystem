...
namespace HMS.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20220704113310_Customer_Field_From_ContactNumber_To_ContactNo")]
    partial class Customer_Field_From_ContactNumber_To_ContactNo
    {
            ...
            modelBuilder.Entity("HMS.Core.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = 1L,
                            CreatedDateTime = new DateTime(2022, 7, 4, 16, 33, 9, 810, DateTimeKind.Local).AddTicks(8649),
                            IsDeleted = false,
                            Name = "Muhammad Zeb"
                        });
                });
