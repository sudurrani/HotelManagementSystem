...
namespace HMS.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20220708062201_Added_IsAllotted_field_to_Room")]
    partial class Added_IsAllotted_field_to_Room
    {
            ...
            modelBuilder.Entity("HMS.Core.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = 1L,
                            CreatedDateTime = new DateTime(2022, 7, 8, 11, 22, 0, 690, DateTimeKind.Local).AddTicks(200),
                            IsDeleted = false,
                            Name = "Muhammad Zeb"
                        });
                });
            ...
            modelBuilder.Entity("HMS.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = 1L,
                            CreatedDateTime = new DateTime(2022, 7, 8, 11, 22, 0, 692, DateTimeKind.Local).AddTicks(7300),
                            IsDeleted = false,
                            Name = "admin"
                        });
                });
            ...
            modelBuilder.Entity("HMS.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = 1L,
                            CreatedDateTime = new DateTime(2022, 7, 8, 11, 22, 0, 692, DateTimeKind.Local).AddTicks(9721),
                            EmployeeId = 1L,
                            IsDeleted = false,
                            Password = "123",
                            RoleId = 1L,
