            ...
            modelBuilder.Entity("HMS.Core.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = 1L,
                            CreatedDateTime = new DateTime(2022, 7, 7, 15, 5, 10, 723, DateTimeKind.Local).AddTicks(3643),
                            IsDeleted = false,
                            Name = "Muhammad Zeb"
                        });
                });
            ...
            modelBuilder.Entity("HMS.Core.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = 1L,
                            CreatedDateTime = new DateTime(2022, 7, 7, 15, 5, 10, 726, DateTimeKind.Local).AddTicks(8717),
                            IsDeleted = false,
                            Name = "admin"
                        });
                });
            ...
            modelBuilder.Entity("HMS.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = 1L,
                            CreatedDateTime = new DateTime(2022, 7, 7, 15, 5, 10, 727, DateTimeKind.Local).AddTicks(1842),
                            EmployeeId = 1L,
                            IsDeleted = false,
                            Password = "123",
                            RoleId = 1L,
